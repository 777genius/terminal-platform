...
impl PsuedoCon {
    pub fn new(size: COORD, input: FileDescriptor, output: FileDescriptor) -> Result<Self, Error> {
        ...
        let result = unsafe {
            // The public CreatePseudoConsole contract documents flag 0 and
            // PSEUDOCONSOLE_INHERIT_CURSOR. Terminal Platform v1 intentionally
            // sticks to flag 0 here so Windows native sessions use the smallest
            // documented ConPTY host contract: plain UTF-8/VT I/O without
            // cursor-inherit or Win32 keyboard-mode side channels.
