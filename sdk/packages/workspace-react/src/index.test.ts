...
type _ComposerRefTargetsElement = Assert<
  Equal<
    React.ComponentRef<typeof TerminalCommandComposer>,
    TerminalCommandComposerElement
  >
>;
type _ComposerDraftProp = Assert<
  Equal<ComposerProps["draft"], string | undefined>
>;
type _ComposerMinRowsProp = Assert<
  Equal<ComposerProps["minRows"], number | undefined>
>;
...
type _ComposerDraftChangeEvent = Assert<
  Equal<
    EventParameter<ComposerProps["onCommandDraftChange"]>,
...
type _ComposerShortcutEvent = Assert<
  Equal<
    EventParameter<ComposerProps["onCommandShortcut"]>,
    CustomEvent<TerminalCommandComposerShortcutDetail>
  >
>;
type _ComposerPasteEvent = Assert<
  Equal<EventParameter<ComposerProps["onCommandPaste"]>, CustomEvent<void>>
>;
type _ComposerSubmitEvent = Assert<
  Equal<EventParameter<ComposerProps["onCommandSubmit"]>, CustomEvent<void>>
>;
...
type _ScreenCopiedEvent = Assert<
  Equal<
    EventParameter<ScreenProps["onScreenCopied"]>,
    CustomEvent<TerminalScreenCopiedDetail>
  >
>;
type _ScreenCopyFailedEvent = Assert<
  Equal<
    EventParameter<ScreenProps["onScreenCopyFailed"]>,
    CustomEvent<TerminalScreenCopyFailedDetail>
  >
>;
type _ScreenInputSubmittedEvent = Assert<
  Equal<
    EventParameter<ScreenProps["onScreenInputSubmitted"]>,
    CustomEvent<TerminalScreenInputSubmittedDetail>
  >
>;
type _ScreenInputFailedEvent = Assert<
  Equal<
    EventParameter<ScreenProps["onScreenInputFailed"]>,
    CustomEvent<TerminalScreenInputFailedDetail>
  >
>;
type _ScreenPasteSubmittedEvent = Assert<
  Equal<
    EventParameter<ScreenProps["onScreenPasteSubmitted"]>,
    CustomEvent<TerminalScreenPasteSubmittedDetail>
  >
>;
type _ScreenPasteFailedEvent = Assert<
  Equal<
    EventParameter<ScreenProps["onScreenPasteFailed"]>,
    CustomEvent<TerminalScreenPasteFailedDetail>
  >
>;
type _ComposerReactHandlerType = Assert<
  Equal<
    NonNullable<
      TerminalCommandComposerReactEventHandlers["onCommandDraftChange"]
    >,
...
type _WorkspaceInspectorModeProp = Assert<
  Equal<
    WorkspaceProps["inspectorMode"],
    TerminalWorkspaceInspectorMode | undefined
  >
>;
type _WorkspaceNavigationModeProp = Assert<
  Equal<
    WorkspaceProps["navigationMode"],
    TerminalWorkspaceNavigationMode | undefined
  >
>;
type _WorkspaceLayoutPresetProp = Assert<
  Equal<
    WorkspaceProps["layoutPreset"],
    TerminalWorkspaceLayoutPreset | undefined
  >
>;
