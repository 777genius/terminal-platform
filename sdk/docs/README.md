...
11. [Keyboard And Focus Behavior](./keyboard-and-focus-behavior.md)
12. [Security Model](./security-model.md)
13. [Workspace Command History Model](./workspace-command-history-model.md)
14. [Degraded Semantics Policy](./degraded-semantics-policy.md)
15. [Diagnostics Model](./diagnostics-model.md)
16. [Performance Model](./performance-model.md)
17. [Product Expansion Model](./product-expansion-model.md)
18. [Build And CI Model](./build-and-ci-model.md)
19. [Runtime Types Generation Model](./runtime-types-generation-model.md)
20. [Examples Policy](./examples-policy.md)
21. [Dependency Management Policy](./dependency-management-policy.md)
22. [Workspace Bootstrap Spec](./workspace-bootstrap-spec.md)
23. [Package Template Spec](./package-template-spec.md)
24. [Governance Model](./governance-model.md)
25. [Implementation Checklist](./implementation-checklist.md)
26. [ADR Set](./adr/)
