...
import { WebSocketTerminalWorkspaceSessionStateStream } from "../dist/features/terminal-workspace/renderer/adapters/WebSocketTerminalWorkspaceSessionStateStream.js";
...
test("session stream reconnects and resubscribes after transient socket loss", async () => {
  ...
  const adapter = new WebSocketTerminalWorkspaceSessionStateStream(url);
