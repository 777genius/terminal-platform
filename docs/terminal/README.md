...
| [v1-manual-closeout-runbook.md](./v1-manual-closeout-runbook.md) | Practical runbook for the final non-automated v1 gate: how to scaffold draft run files, execute the real Electron/tmux/Windows checklists, promote finished artifacts into `manual/runs`, and re-run the strict readiness audit |
...
| [v1-release-candidate-summary.md](./v1-release-candidate-summary.md) | Stable release handoff artifact for the first public v1 candidate: support matrix, included scope, non-promises, degraded semantics, and proof still required before tagging |
