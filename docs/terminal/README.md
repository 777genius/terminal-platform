...
| [v1-release-candidate-checklist.md](./v1-release-candidate-checklist.md) | Final ship-ready closeout checklist: canonical remote, hosted CI proof, recorded manual passes, readiness audit command, and release summary template for the first public v1 candidate |
