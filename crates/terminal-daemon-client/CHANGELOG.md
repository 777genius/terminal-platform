...
## [0.1.0](https://github.com/777genius/terminal-platform/releases/tag/terminal-daemon-client-v0.1.0) - 2026-08-02
...
- *(ci)* isolate test daemon sqlite stores
- *(ci)* gate title fallback test to unix
- *(ci)* use shell-free windows title test launch
- *(ci)* stabilize title delta tests
