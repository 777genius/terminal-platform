...
pub(super) fn upsert_terminal_output_target(
    store: &TerminalPersistenceV2,
    input: &TerminalOutputEventInput,
) -> Result<(), TerminalPersistenceV2Error> {
    store.upsert_runtime_session(SessionInput {
    ...
    store.upsert_runtime_pane(PaneInput {
...
pub(super) fn upsert_history_gap_target(
    store: &TerminalPersistenceV2,
