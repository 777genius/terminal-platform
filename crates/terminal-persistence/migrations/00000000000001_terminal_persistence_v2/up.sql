...
CREATE TABLE IF NOT EXISTS terminal_backend_capability_reports (
    ...
    capture_semantics TEXT NOT NULL CHECK(capture_semantics IN ('raw_vt_stream', 'rendered_ansi_stream', 'rendered_screen_snapshot', 'rendered_plaintext_snapshot', 'mux_structured_surface', 'imported_text', 'ui_input')),
...
CREATE TABLE IF NOT EXISTS terminal_stream_segments (
    ...
    capture_semantics TEXT NOT NULL DEFAULT 'raw_vt_stream' CHECK(capture_semantics IN ('raw_vt_stream', 'rendered_ansi_stream', 'rendered_screen_snapshot', 'rendered_plaintext_snapshot', 'mux_structured_surface', 'imported_text', 'ui_input')),
