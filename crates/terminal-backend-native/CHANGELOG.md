...
## [0.1.0](https://github.com/777genius/terminal-platform/releases/tag/terminal-backend-native-v0.1.0) - 2026-08-02

### Added

- *(native)* render rich terminal output
...
- *(ci)* restore clippy and fuzz baseline
