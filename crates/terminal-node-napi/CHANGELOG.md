...
## [0.2.0](https://github.com/777genius/terminal-platform/releases/tag/terminal-node-napi-v0.2.0) - 2026-08-02

### Added

- *(node)* expose rich screen DTOs
...
- *(ci)* isolate installed package smoke daemons
- *(ci)* isolate test daemon sqlite stores
- *(ci)* stabilize zellij list-panes readiness
