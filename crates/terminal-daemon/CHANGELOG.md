...
## [0.1.0](https://github.com/777genius/terminal-platform/releases/tag/terminal-daemon-v0.1.0) - 2026-08-02

### Added

- *(runtime)* persist terminal capture semantics
...
- *(ci)* compile daemon tests for backend bundles
